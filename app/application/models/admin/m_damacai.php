    ...
    public function btn3djp()
    {
        if(isset($_POST['ContentConvert']))
        {
            if(isset($_SESSION['txday']))
                ...
                $txday              = date("Ymd");
            $ContentConvert         = $_POST['ContentConvert'];
            //$arr_convert            = explode(" + ",explode("\n", $ContentConvert)[0]);
            $arr_convert            = explode("\n", $ContentConvert);
            $arr_3djp = array();
            if(count($arr_convert) > 0)
            {
                for($i=0 ; $i <count($arr_convert);$i++)
                {
                    array_push($arr_3djp,$arr_convert[$i]);
                }
            }
            //return
            $arr                    = array(
    ...
    */
    public function btnsaveall_damacai()
    {
        ...
        if(isset($_POST["spandrawno"]))
        {
            ...
            if(isset($_POST["span_1st_1_3d"]))
                $span_1st_1_3d      =   $_POST["span_1st_1_3d"];
            if(isset($_POST["span_2nd_1_3d"]))
                $span_2nd_1_3d      =   $_POST["span_2nd_1_3d"];
            if(isset($_POST["span_3rd_1_3d"]))
            ...
            if(isset($_POST["span_1st_3d"]))
                $span_1st_3d        =   $_POST["span_1st_3d"];
            if(isset($_POST["span_2nd_3d"]))
                $span_2nd_3d        =   $_POST["span_2nd_3d"];
            if(isset($_POST["span_3rd_3d"]))
                $span_3rd_3d        =   $_POST["span_3rd_3d"];
            
            if(isset($_POST["span_rm_13djp1"]))
                $span_rm_13djp1     =   $_POST["span_rm_13djp1"];
            if(isset($_POST["span_rm_13djp2"]))
                $span_rm_13djp2     =   $_POST["span_rm_13djp2"];
            if(isset($_POST["span_rm_3djp"]))
                $span_rm_3djp       =   $_POST["span_rm_3djp"];
            if(isset($_POST["span_rm_dmcjp1"]))
                $span_rm_dmcjp1     =   $_POST["span_rm_dmcjp1"];
            if(isset($_POST["span_rm_dmcjp2"]))
                $span_rm_dmcjp2     =   $_POST["span_rm_dmcjp2"];
            if(isset($_POST["arr_jp1_13"]))
                $arr_jp1_13         =   $_POST["arr_jp1_13"];
            if(isset($_POST["arr_jp1_23"]))
                $arr_jp1_23         =   $_POST["arr_jp1_23"];
            if(isset($_POST["arr_3djp"]))
                $arr_3djp           =   $_POST["arr_3djp"];
            if(isset($_POST["dmcjp1"]))
                $dmcjp1             =   $_POST["dmcjp1"];
            if(isset($_POST["arr_dmcjp2"]))
            ...
            $str_3djp           =   "";
            if(is_array($arr_3djp))
            {
                foreach($arr_3djp as $row_3djp)
                {
                    $str_3djp    .=  $row_3djp."|";
                }
                $str_3djp        =   substr($str_3djp,0,(strlen($str_3djp)-1));
            }

            $str_dmcjp2        =   "";
            if(is_array($arr_dmcjp2))
            {
            ...
            if($check_isset_row_db > 0)
            {
                $sql                = " UPDATE `lot_damacai` SET 
                                                ...
                                                `1_3DJp2_RM` = '$span_rm_13djp2', `3D_Jp` = '$str_3djp', 
            ...
            else
            {
                $sql                = "INSERT INTO `lot_damacai` 
                                    ...
                                    VALUES ('$txday', '$drawno', '$span_1st_1_3d', '$span_2nd_1_3d', '$span_3rd_1_3d', '$str_special', 
                                            ...
                                            '$str_jp1_23', '$span_rm_13djp2', '$str_3djp',  '$span_rm_3djp', '$dmcjp1', '$span_rm_dmcjp1', '$str_dmcjp2', '$span_rm_dmcjp2')";
            }
    ...
    */
    public function get_data_by_txtdate_damacai()
    {
        ...
        if(isset($_POST['txtdate']))
        {
            ...
            $row_db                 =   $this->m_common_lottery->get_row_by_table_txday("lot_damacai",$str_date);
            if(count($row_db)   >   0)
            {
