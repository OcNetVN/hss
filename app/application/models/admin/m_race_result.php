  ...
  public function getlistraceresultday()
  {
   ...
   public function SaveRaceResultDetail(){
       ...
       if($FirstWin_sn != ""){
        ...
        $SecondWin    = $_POST['WinMal2'];
       if($SecondWin != ""){
          $SecondWin = str_replace("RM ", "", $SecondWin);
          $SecondWin = (int)$SecondWin;
       }
       $SecondWin_sn = $_POST['WinSin2'];
       if($SecondWin_sn != ""){
          $SecondWin_sn = str_replace("$ ", "", $SecondWin_sn);
          $SecondWin_sn = (int)$SecondWin_sn;
       }
       $ThirdWin    = $_POST['WinMal3'];
       if($ThirdWin != ""){
          $ThirdWin = str_replace("RM ", "", $ThirdWin);
          $ThirdWin = (int)$ThirdWin;
       }
       $ThirdWin_sn = $_POST['WinSin3'];
       if($ThirdWin_sn != ""){
          $ThirdWin_sn = str_replace("$ ", "", $ThirdWin_sn);
          $ThirdWin_sn = (int)$ThirdWin_sn;
       }
       $FourWin    = $_POST['WinMal4'];
       if($FourWin != ""){
          $FourWin = str_replace("RM ", "", $FourWin);
          $FourWin = (int)$FourWin;
       }
       $FourWin_sn = $_POST['WinSin4'];
       if($FourWin_sn != ""){
          $FourWin_sn = str_replace("$ ", "", $FourWin_sn);
          $FourWin_sn = (int)$FourWin_sn;
       }
       ...
       if(count($arr_sql) == 0)
       {
           ...
           $sql_sin = "INSERT INTO `raceresult`(`RaceCountry`,`RaceBoard`,`RaceCardId`,`FirstHorse`,
                                        ...
                                        VALUES('$RaceCountry','SIN','$RaceCardId','$FistHorse','$FirstLength',
                                                ...
                                                '$SecondWin_sn','$ThirdWin_sn','$FourWin_sn'
                                                )";
           $req_sin = $this->db->query($sql_sin);
            ...
            $sql = "UPDATE `raceresult` SET `RaceDay`='$RaceDay',`FirstHorse`='$FistHorse',`FirstLength`='$FirstLength',
                                            ...
                                            `SecondWin`= '$SecondWin',`ThirdWin`= '$ThirdWin', `FourthWin`='$FourWin'
                                          WHERE `RaceCardId`='$RaceCardId' AND `RaceBoard` = 'MAL'";
            $req  = $this->db->query($sql); 
            $sql_sin = "UPDATE `raceresult` SET `RaceDay`='$RaceDay',`FirstHorse`='$FistHorse',`FirstLength`='$FirstLength',
                                                ...
                                                `Quadro2`='$Quadro2_sn',
                                                `SecondWin`= '$SecondWin_sn',`ThirdWin`= '$ThirdWin_sn', `FourthWin`='$FourWin_sn' 
                                            WHERE `RaceCardId`='$RaceCardId' AND `RaceBoard` = 'SIN' ";
            $req_sin = $this->db->query($sql_sin);
       }
