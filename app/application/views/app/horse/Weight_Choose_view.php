<table width="100%" border="0" cellspacing="0" cellpadding="0" >
                    ...
                    <td width="60%" align="left">
                        <div style="vertical-align: middle; color: white; cursor: pointer;" onclick="history.back();">
                          ...
                          <span style="vertical-align: middle;padding-bottom:25px;">
                            <?php
                                echo $this->lang->line(LANG_WEIGHT_T);
                            ?>
                          </span>
                        </div>
                    </td>
  ...
  <tr>
    <td style="font-size:Large; border: 1px solid black;" id="trcountrysee">
        <!--load data-->
    </td> 
  </tr>
  <tr>
    <td style="font-size:Large; padding-top: 10px;" id="tdlistrace">
        <!--load data-->
    </td>  
  </tr>
</table>