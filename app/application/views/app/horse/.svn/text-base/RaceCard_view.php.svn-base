                    ...
                    <td width="90%" align="left">
                       ...
                       <!--  <a href="<?php //echo base_url('/app/horse/horse_info') ?>" style="text-decoration: none;"> -->
                                <div style="vertical-align: middle; color: white; ">
                                   <input type="image" name=""  title="Home" src="<?php echo base_url('assets/img/app/btn-back.png') ?>" onclick="history.back(); return false;" style="height:50px;width:50px;border-width:0px;">
