        ...
        <td>
            <div style="margin: 5px; border:1px solid #000; padding:0px 5px;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>';
                        <td width="50%"><input type="image" title="" src="'.base_url('assets/img/app/flag/'.$arr_flag[$row->RaceCountry]).'">BBBB<!--'.$arr_country[$row->RaceCountry].'--></td>
                        <td width="35%" align="right">AAAAAAAAAA<!--'.$day_race.'--></td>';
