                      ...
                      <?php   } ?>
                        <!-- <a href="<?php //echo base_url('/app/soccer/result') ?>"> -->
                            <input type="image"  title="Result" src="<?php echo base_url('assets/img/app/result_en.png') ?>" style="width:40px;border-width:0px;">
                             <?php 
                              if($this->lang->line(LANG_EN) == "English")
                              { // tiếng ANh ?>
                                   <span style="font-size: 10px; margin-left: -47px; position: fixed; margin-top: 48px;"><?="Result" ?></span>  
                                   <?php  }
                              else
                              { // Tiếng tàu ?>
                                 <span style="font-size: 10px; margin-left: -47px; position: fixed; margin-top: 48px;"><?="成绩"?></span>
                              <?php   } ?> 
                        </a>
                        <?php 
                              if($this->lang->line(LANG_EN) == "English")
                        ...
                        <?php  } ?>
                            ...
                            <?php 
                              if($this->lang->line(LANG_EN) == "English")
                              { // tiếng ANh ?>
                                   <span style="font-size: 10px; margin-left: -47px; position: fixed; margin-top: 48px;"><?="Info" ?></span>  
                                   <?php  }
                              else
                              { // Tiếng tàu ?>
                                 <span style="font-size: 10px ;margin-left: -47px; position: fixed; margin-top: 48px;"><?="信息"?></span>
                              <?php   } ?> 
                        </a>
                         <?php 
                              if($this->lang->line(LANG_EN) == "English")
                        ...
                        <?php  } ?>
                            <input type="image" name="" id="" title="Table" src="<?php echo base_url('assets/img/app/table_en.png') ?>" style="width:40px;border-width:0px;">
                             <?php 
                              if($this->lang->line(LANG_EN) == "English")
                              { // tiếng ANh ?>
                                   <span style="font-size: 10px; margin-left: -47px; position: fixed; margin-top: 48px;"><?="Next" ?></span>  
                                   <?php  }
                              else
                              { // Tiếng tàu ?>
                                 <span style="font-size: 10px; margin-left: -47px; position: fixed; margin-top: 48px;"><?="下页"?></span>
                              <?php   } ?>   
                        </a>
                    </td>
                </tr>
  ...
  <tr>
    <td id="tbllistracecard">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-weight:bold;">
        <tr>
            <td style="padding-bottom:40px;padding-top:2px;" id="showInfoEarly">
                 <?php echo $HTMLInfo;?>
            </td>
        </tr>
      </table>
