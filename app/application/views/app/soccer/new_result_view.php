                ...
                <tr>
                    ...
                    <td align="center" width="20%">
                        <div style="vertical-align: middle; color: white;">
                              <b><?php echo $this->lang->line(LANG_RESULT);?></b>
                        </div>
                    </td>
                    <td  align="right" width="60%">
                      ...
                      <?php   } ?>
                       <!--  <a href="<?php //echo base_url('/app/soccer/result') ?>"> -->
                        ...
                        <?php  } ?>
                            <input type="image" name="" id="" title="Goal" src="<?php echo base_url('assets/img/app/scc_info.png') ?>" style="width:40px;border-width:0px;">
                             <?php 
                              if($this->lang->line(LANG_EN) == "English")
                              { // tiếng ANh ?>
                        ...
                        <?php  } ?>
                            <input type="image" name="" id="" title="Table" src="<?php echo base_url('assets/img/app/live_next.png') ?>" style="width:40px;border-width:0px;">
                             <?php 
                              if($this->lang->line(LANG_EN) == "English")
                              { // tiếng ANh ?>
