            ...
            <tbody>
                <tr>
                    ...
                    <td align="right" width="60%">
                      ...
                      <?php   } ?>
                        <!-- <a href="<?php //echo base_url('/app/soccer/result') ?>"> -->
                            <input type="image"  title="Result" src="<?php echo base_url('assets/img/app/soccer_league.png') ?>" style="width:40px;border-width:0px;">
                              <?php 
                              if($this->lang->line(LANG_EN) == "English")
                              { // tiếng ANh ?>
                                   <span style="font-size: 10px; position: absolute; margin-left: -42px;margin-top: 37px;"><?="League" ?></span>  
                                   <?php  }
                              else
                              { // Tiếng tàu ?>
                                 <span style="font-size: 10px; position: absolute; margin-left: -42px;margin-top: 37px;"><?="聯賽"?></span>
                              <?php   } ?>
                        </a>
                        <?php 
                              if($this->lang->line(LANG_EN) == "English")
                        ...
                        <?php  } ?>
                            <input type="image" name="" id="" title="Logout" src="<?php echo base_url('assets/img/app/table_en.png') ?>" style="width:40px;border-width:0px;">
                              ...
                              if($this->lang->line(LANG_EN) == "English")
                              { // tiếng ANh ?>
                                   <span style="font-size: 10px; position: absolute; margin-left: -42px;margin-top: 37px;"><?="Tables" ?></span>  
                                   <?php  }
                              else
                              { // Tiếng tàu ?>
                                 <span style="font-size: 7px; position: absolute; margin-left: -42px;margin-top: 39px;"><?="排名表"?></span>
                              <?php   } ?>
                        ...
                        <?php  } ?>
                            <input type="image"  title="Table" src="<?php echo base_url('assets/img/app/livesoce.png') ?>" style="width:40px;border-width:0px;">
                             <?php 
                              if($this->lang->line(LANG_EN) == "English")
                              { // tiếng ANh ?>
                                   <span style="font-size: 7px; position: absolute; margin-left: -50px;margin-top: 40px;"><?="Correct Score" ?></span>  
                                   <?php  }
                              else
                              { // Tiếng tàu ?>
                                 <span style="font-size: 10px; position: absolute; margin-left: -35px;margin-top: 37px;"><?="玻胆"?></span>
                              <?php   } ?>
                        </a>
                    </td>
                </tr>
