            ...
            <tbody>
                <tr>
                    <td width="90%" align="left">
                        ...
                        <span>
                        <?php
                             echo $this->lang->line(LANG_SIN_4D);
                         ?>
                        </span>
                        </div>
                    </td>
              ...
              <tr>
                <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td align="center" height="50">
                        	<!-- <strong style="padding:5px; border:2px #F30 solid; width: 100px; text-align:center; background-color:#000; color:#FFF">SUN 20-05-2014 Day</strong> -->
                        </td>
                      </tr>
                    </table>
                </td>
                                          ...
                                          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tbody><tr>
                                                  ...
                                                  <td width="20%" align="center" valign="middle" bgcolor="#666666">
                                                  		<input type="image" name="" id="" title="Home" src="<?php echo base_url('assets/img/app/Logo-Singapore-pool.png'); ?>" style="height:90px;border-width:0px;padding: 10px;">
                                                  </td>
