                    ...
                    <td width="90%">
                        <div style="vertical-align: middle; color: white; cursor: pointer;" onclick="history.back();">
                          <img src="<?php echo base_url('assets/img/app/btn-back.png') ?>" width="45" height="45" alt="Back" />
                           <span>
                           <?php
                               echo $this->lang->line(LANG_CASH_SWEEP);
                           ?>
                           </span>
                        </div>
                    </td>
              ...
              <tr>
                <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:large; color:#FFF; font-weight:bold;">
                    	  <tr>
                    	    <td height="35" bgcolor="#009900"><?php
                               echo $this->lang->line(LANG_CASH_SWEEP);
                           ?></td>
                    	  ...
                    	  <tr>
                    	    <td bgcolor="#CCCC33">
                            	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          ...
                                          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tbody><tr>
                                                  <td width="40%" height="63" valign="middle" bgcolor="#666666"><?php
                               echo $this->lang->line(LANG_LOT_DATE);
                           ?>:<br>
                                                    <span id="span_date"></span></td>
                                                  <td width="20%" align="center" valign="middle" bgcolor="#666666">
                                                  		<input type="image" name="" id="" title="Home" src="<?php echo base_url('assets/img/app/logo-cashWeep.png'); ?>" style="height:50px;width:50px;border-width:0px;">
                                                  </td>
                                                  <td width="40%" align="right" valign="middle" bgcolor="#666666"><?php
                               echo $this->lang->line(LANG_DRAW_NO);
                           ?>:<br>
                                                    <span id="spandrawno"></span></td>
                                                </tr>
                                                <tr>
                                                  <td height="35" align="center" valign="middle" bgcolor="#333333"><?php
                           ...
                           ?></td>
                                                ...
                                                <tr>
                                                  <td height="35" align="center" valign="middle" bgcolor="#666666"><span id="span_1st_1"></span></td>
                                                  <td height="35" align="center" valign="middle" bgcolor="#666666"><span id="span_2nd_1"></span></td>
                                                  <td height="35" align="center" valign="middle" bgcolor="#666666"><span id="span_3rd_1"></span></td>
                                                </tr>
                                                <tr>
                                                  <td height="35" align="center" valign="middle" bgcolor="#666666"><span id="span_1st_2"></span></td>
                                                  <td height="35" align="center" valign="middle" bgcolor="#666666"><span id="span_2nd_2"></span></td>
                                                  <td height="35" align="center" valign="middle" bgcolor="#666666"><span id="span_3rd_2"></span></td>
                                                </tr>
                                              </tbody></table>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tbody><tr>
                                                  <td height="33" colspan="5" align="center" valign="middle" bgcolor="#333333"><?php
                           ...
                           ?></td>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tbody><tr>
                                                  <td height="35" colspan="5" align="center" valign="middle" bgcolor="#333333"><?php
