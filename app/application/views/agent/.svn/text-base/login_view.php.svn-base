...
<head>
  ...
  <body class="login-body">
    ...
    <div class="container">
      ...
      <?php echo form_open(base_url('agent/dashboard'), array('class' => "form-signin", 'id'	=>	'form')); ?>
        <h2 class="form-signin-heading"><?php echo $this->lang->line(LANG_TITE_AGENT_LOGIN); ?></h2>
