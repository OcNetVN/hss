                ...
                <div class="row">
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-2">
                                <button class="btn btn" id="btnclearall" style=" width:200px;margin-bottom:5px;" type="button" onclick="ClearAll();"> Clear All </button> <br />
                                <button class="btn btn" id="btndrawdate" style=" width:200px; margin-bottom:10px;" type="button" onclick="ConvertSave();">Eng Today convert & Save</button>
                                <button class="btn btn" id="btnfourdgame" style=" width:200px; margin-bottom:10px;" type="button" onclick="ConvertSaveToday();">Chi Today convert & Save</button><br />
