                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <button class="btn btn" id="btndrawdate" style=" width:200px; margin-bottom:10px;" type="button" onclick="ConvertEarlyMarket();">  English Early Convert </button>
                                            <button class="btn btn" id="btndrawdate" style=" width:200px; margin-bottom:10px;" type="button" onclick="ConvertEarlyMarketCN();"> Chinese Early Convert</button>
                                           <br /> 
                                        </div>
                                    </div>
                                  </div>
