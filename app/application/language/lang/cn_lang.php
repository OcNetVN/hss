...
$lang         =    array(
                ...
                */
                LANG_LOTTRY                             =>    "博彩",
                LANG_LIVE_DRAW                          =>    "现场开彩",
                LANG_WEST_MALAYSIA                      =>    "西马彩票",
                LANG_DAMACAI                            =>    "大马彩",
                LANG_MAGNUM                            =>    "万能万字",
                LANG_SPORT_TOTO                        =>    "Sport Toto",
                LANG_BIG_SWEEP                        =>    "大彩",
                LANG_2D                                =>    "字花",
                LANG_SINGAPORE                       =>    "新加坡彩票",
                LANG_SINGAPORE_4D                    =>  "新加坡彩票4D",
                LANG_SINGAPORE_TOTO                 =>  "新加坡彩票ToTo",
                LANG_LOSIN                         =>    "新加坡彩票",
                LANG_TOTO                            =>    "多多",
                LANG_POOLS_4D                        =>    "Pools 4D",
                LANG_SWEEP                            =>    "大彩",
                LANG_EAST_MALAYSIA                    =>    "东马彩票",
                LANG_SABAH_88                        =>    "沙巴 88",
                LANG_STC_4D                            =>    "山打根万字",
                LANG_CASH_SWEEP                        =>    "大万万字",

                // image lottry
                LANG_MAL_LIVE_IMG => "assets/img/app/logo-Mal-Live-cn.png",
                LANG_SIN_LIVE_IMG => "assets/img/app/logo-Sinl-Live-cn.png",
                LANG_LIVE_2D_IMG  => "assets/img/app/Logo-Live-2D-cn.png",
                ...
                */
				...
				LANG_JACKPOT_PR => "积宝奖",	
				LANG_WINNING_NUMBERS =>"中奖数字",
				LANG_ADDITIONAL_NUMBERS =>"另外数字",
				LANG_WINNING_SHARES=>"中奖股份",
				
				LANG_PRIZE_GRP=>"奖组",
				LANG_SHARE_AMT=>"份额",
				LANG_NO_OF_WIN_SHARE =>"中奖股份的数字",
                                LANG_MY_PLAY_NUMBER => "我的玩数",
				
				LANG_LANGUAGE_CODE =>"1",
                
                //12/05/2015
                LANG_PASS_NOT_RIGHT            =>     "密码不正确，请再试一次！",
                LANG_NOT_ACTIVE                =>     "您的账户处于飞活动状态。请联系管理员！",
                LANG_USERNAME_NOT_RIGHT        =>     "用户名错误。请再输入！",
                LANG_NOT_PERMIT                =>     "你没有这个功能权限！",

                //  menu main setting
                 LANG_SETTING              => "SETTING",
                 LANG_SERIAL_NUMBER        => "序列号码",
                 LANG_HORSE_NOTIFICATIONS  => "赛马告示",
                 LANG_LOTTRY_NOTIFICATIONS => "彩票告示",
                 LANG_SOCCER_NOTIFICATIONS => "足球告示",
                 LANG_NOTIFICATIONS        => "告示历史",
                 LANG_TELL_YOUR_FRIENDS    => "告诉朋友",
                 LANG_SET_PASSCODE         => "设定密码",
                 LANG_FEEDBACK             => "顾客反馈",
                 LANG_CHECKFORUPDATE       => "更新捡查",
                 LANG_ABOUT_US             => "关于我们",
                 LANG_NOTIFICATION         => "Notifications",
                 LANG_VESRSION             => "版本",
                 LANG_PLEASE_FEEL =>"请输入任何评价或建议。",
                 LANG_WE_WILL     => "对于您的任何评价或建议，我们将非常感激",
                 LANG_THANKS_YOU  => "谢谢你们的支持。",

                 LANG_MES_OUT_OF_DATE_LOGIN_APP       => "你的户口已过期。",
                 LANG_CONTACT_YOUR_AGENT              => "请连络代理。",
                 

                  // horse notifications
                 LANG_SOUND => "响音",
                 LANG_VIBRATION=> "震动",
                 LANG_RACING_DAY => "赛马赛期",
                 LANG_TIPS       => "贴士",
                 ...
                 LANG_INSERT_YOUR_PLAY  => "记录我的投注号码",
                 LANG_4D_NUMBER_HISTORY => "4D彩票历史",
                 LANG_MY_PLAY_NUMBER    => "投注的号码",
                ...
                // menu main Soccer
                 ...
                 LANG_LIVE   => "滚球",
                 LANG_TODAY  => "赛事",
                 LANG_EARLY_MARKET => "早盘",
                 LANG_LIVE_SCORE   => "波胆",
                 LANG_FAVOURITE   => "最喜爱的",
                 LANG_RESULT      => "成绩",
                 LANG_NUMBER      => "数号",
                 LANG_soccer_info => "足球",
                 LANG_soccer_info_board=> "足球 讯",
                 ...
                 LANG_Ladbrokes        => "立博盘",
                 LANG_DATE_TIME        =>"日期时间",
                 LANG_FIRST_HALF       =>"上半场赛果",
                 LANG_FULL_TIME        =>"完场赛果", 
                 LANG_FT_FH            => "全场 & 半场 波胆", 
                 LANG_Scratching =>     "割马",
                 LANG_MaterChoice =>     "马师父评估",
                 LANG_BatamTic    =>     "巴淡行票"
            );
/*
|--------------------------------------------------------------------------
