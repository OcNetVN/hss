<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $route['admin/net_ticket']              =       "admin/home_controller/net_ticket";
    $route['admin/weight_board']			=		"admin/home_controller/weight_board";
    $route['admin/set']						=		"admin/home_controller/set";
    $route['admin/ScratchingEarlyTicket']   =       "admin/home_controller/ScratchingEarlyTicket";
    ...
    $route['admin/setlang']                =        "admin/login_controller/setlang";
    /*
    | ------------------------------------------------------------------------------------------
    ...
    */
    ...
    $route['scc/manual_live_score']        =        "admin/home_controller/manual_live_score";
    ...
    $route['scc/ladbrokes']                 =        "admin/home_controller/soccer_ladbrokes"; 
    $route['scc/soccer_info']                 =        "admin/home_controller/soccer_info"; 
    $route['scc/score_correct']                 =        "admin/home_controller/score_correct"; 
    ...
    */
    ...
    $route['super_admin/setlang']				=		"super_admin/login_controller/setlang";
    ...
    */
    ...
    $route['app/soccer/main']                       =        "app/home_controller/soccer_main";
    $route['app/soccer/live']                       =        "app/home_controller/soccer_live";
    $route['app/soccer/earlymarket']               =        "app/home_controller/soccer_early";                                                                                            //soccer_early
    ...
    $route['scc/soccer_ladbrokes']         =        "admin/home_controller/soccer_ladbrokes";
    $route['home_controller/SaveSoccerInfo']         =        "admin/home_controller/SaveSoccerInfo";
