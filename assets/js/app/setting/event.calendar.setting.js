...
function getevent()
{
    ...
    $.ajax({
                type:"POST",
                url: "../home_controller/loadmyplaynumber",
                dataType:"text",
                data:{typechoose: sechoose},
                cache:false,
...
function loadlistdate_complete(data)
{
    ...
    //$('.day-contents').attr({style: "background: #FFF; color:#797979;"});
...
{   
    ...
    $('.day-contents').bind("click",function()
    {
            ...
            //$('.calendar-day-' + divdate).attr({ style:"background:red;"});

            $('.calendar-day-'+ divdate + ' .day-contents').attr({
                        style: "background: red; color:#FFF;",
                        id: "dayevent_" + divdate
                  });

            $("#txtdate").val(date);
            var lottry = $("#sechoose").val();
            get_data_by_txtdate(date,lottry);
            getevent();
            /*
...
function getselecteddate()
{
    ...
    var date = year + arr_month[month] + day;
