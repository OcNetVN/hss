...
function getevent()
{
        ...
        if(sechoose == "damacai")
        {
             $.ajax({
                        type:"POST",
                        url: "../admin/homeld_controller/loadlistdatedamacai",
                        dataType:"text",
                        //data: { Country: Coutry},
                        cache:false,
        ...
        if(sechoose == "magnum")
        {
            $.ajax({
                        type:"POST",
                        url: "../admin/homeld_controller/loadlistdatemagnum",
                        dataType:"text",
                        //data: { Country: Coutry},
                        cache:false,
                        success:function (data) 
        ...
        if(sechoose == "toto")
        {
            $.ajax({
                        type:"POST",
                        url: "../admin/homeld_controller/loadlistdatetoto",
                        dataType:"text",
                        //data: { Country: Coutry},
                        cache:false,
                        success:function (data) 
        ...
        if(sechoose == "sinfourd")
        {
            $.ajax({
                        type:"POST",
                        url: "../admin/homeld_controller/loadlistdatesin4D",
                        dataType:"text",
                        //data: { Country: Coutry},
                        cache:false,
                        success:function (data) 
        ...
        if(sechoose == "sintoto")
        {
            $.ajax({
                        type:"POST",
                        url: "../admin/homeld_controller/loadlistdatesintoto",
                        dataType:"text",
                        //data: { Country: Coutry},
                        cache:false,
                        success:function (data) 
